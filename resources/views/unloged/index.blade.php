...
<div id="simplecookienotification_v01" style="display: block; z-index: 99999; min-height: 35px; width: 300px; position: fixed; background: rgb(255, 243, 224); border: 1px solid rgb(255, 152, 0); text-align: center; right: 10px; color: rgb(119, 119, 119); bottom: 10px;">
    <div style="padding:10px; margin-left:15px; margin-right:15px; font-size:14px; font-weight:normal;">
        ...
        <a id="simplecookienotification_v01_polityka" href="{{ route('politics') }}" style="color: rgb(255, 152, 0);">Polityka Prywatności</a><span id="br_pc2_title_html"> &nbsp;&nbsp; </span>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top shadow p-3 mb-5 rounded" id="sideNav" >
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <span class="d-block d-lg-none">
            <div class="avatar">
                  <img class="img-fluid img-profile rounded-circle mx-auto shadow p-1 rounded" src="{{ asset('assets/img/logo.png') }}" alt="" style="width: 50px; height: 50px;" />
                JuniorsGallery
            <div class="status offline"></div>
            </div>
        </span>
        <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2 shadow p-2 mb-3 rounded" src="{{ asset('assets/img/logo.png') }}" alt="" /></span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ url('/register') }}">{{ __('Register') }}</a></li>

...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top shadow-lg p-3 mb-5 rounded" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link js-scroll-trigger" href=""><i class="far fa-comments" style="width: 25px; height: 25px;"></i> <strong>{{ auth()->user()->received()->count() }}</strong></a></li>
